...
type FechaCivil = { anio: number; mes: number; dia: number; hora: number; minuto: number; segundo: number };
...
function instanteDeCorte({ anio, mes, dia }: Pick<FechaCivil, "anio" | "mes" | "dia">): number {
