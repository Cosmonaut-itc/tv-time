...
**Dónde va, al cerrar las ocho rebanadas:** la app está construida, desplegada en `cine.felixddhs.dev` y aceptada en el iPhone real. **El destino no está alcanzado**: la sala todavía no ha decidido una función real —38 títulos, 0 vistos— y eso no lo puede hacer una sesión de trabajo. Falta una noche, no una rebanada.
...
- [El giro, de verdad](tickets/015-el-giro-de-verdad.md) — los dos actos, los dos vetos y la vuelta en vacío que señala el filtro. **El corte de las 5 a.m. se mudó al servidor** ([`convex/noche.ts`](../convex/noche.ts)): con el reloj en el cliente, mover la hora fabricaba noches y con ellas vetos infinitos. La derivación de la cartelera bajó a Convex para que el servidor no se deje vaciar. Giro dramático ~13 s con **0 peticiones a `image.tmdb.org`**.
