// El logo oficial de TMDB, descargado de su página de marca y puesto aquí en
// línea. Los términos de uso exigen dos cosas juntas —el texto exacto y el
// logo— y el logo tiene que verse «less prominent than the logos or marks that
// primarily describe or identify Your Application»: de ahí que viva al pie, en
// 92px, muy por debajo de la marquesina de la sala.
//
// Va en línea y no en `public/` por dos motivos: no cuesta una petición más en
// una pantalla que ya carga pósters, y así el gradiente lleva un id propio.
// El SVG original trae un `<style>` con `.cls-1` que, inlinado tal cual, se
// escaparía al documento entero.
export default function LogoTmdb() {
  return (
    <svg
      className="logo-tmdb"
